...
for(anc in 1:nanc){
  ...
  col2="#00000080"
  plot(x[,1],x[,2],type="l",log="y",xlim=c(0,60),ylim=c(1e2,1e6),xlab="g (generations before present)",ylab="Ne (effective population size)",xaxs="i",yaxt="n",las=1,lwd=2.5,lty=32,col="lightgray",main=paste(pops[anc],"ancestry"))
